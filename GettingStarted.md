...
- The `import` statements at the top of the file allow `App.js` to use code that has been defined elsewhere.
...
- When you save, the app should now greet you with "Hello, Clarice!".
